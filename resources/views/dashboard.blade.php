                    ...
                    <div class="card-body d-flex px-4 pb-0 justify-content-between">
                        <div>
                            ...
                            <div class="d-flex align-items-center">
                                <h2 class="fs-32 font-w700 mb-0">{{$total_detection}}</h2>
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                            <div class="">
                                <h2 class="fs-32 font-w700">{{$total_crash}}</h2>
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                            <div class="">
                                <h2 class="fs-32 font-w700">{{$total_cars}}</h2>
            ...
            <div class="col-xl-6 col-sm-6">
                <div class="card">
                    <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                            <div class="">
                                <h2 class="fs-32 font-w700">{{$total_bus}}</h2>
            ...
            <div class="col-xl-12    col-sm-6">
                <div class="card">
                    <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                            <div class="">
                                <h2 class="fs-32 font-w700">{{$total_motos}}</h2>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: {!! json_encode($total_crashes_by_month) !!},
